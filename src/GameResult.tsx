  ...
  return (
    ...
    >
      <Stack align="center">
        ...
        <Space />
        {isWin && <Text>
          You got the copy pasta! Share this results with your frens!
        </Text>}
        {isLose && <Text>
          You might not have gotten the correct answer, but you can still share
          this result with your frens.
        </Text>}
